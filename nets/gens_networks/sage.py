...
class GensSAGE1(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, nlayer=1):
        super(GensSAGE1, self).__init__()
...
class GensSAGE2(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, nlayer=2):
        super(GensSAGE2, self).__init__()
...
class GensSAGEX(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, nlayer=3):
        super(GensSAGEX, self).__init__()
        self.conv1 = SAGEConv(nfeat, nhid)
        self.conv2 = SAGEConv(nhid, nclass)
...
def create_sage(nfeat, nhid, nclass, dropout, nlayer):
    if nlayer == 1:
        model = GensSAGE1(nfeat, nhid, nclass, dropout, nlayer)
    elif nlayer == 2:
        model = GensSAGE2(nfeat, nhid, nclass, dropout, nlayer)
    else:
        model = GensSAGEX(nfeat, nhid, nclass, dropout, nlayer)
    return model
