...
class GensGCN1(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, nlayer=1):
        super(GensGCN1, self).__init__()
...
class GensGCN2(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, nlayer=2):
        super(GensGCN2, self).__init__()
...
class GensGCNX(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, nlayer=3):
        super(GensGCNX, self).__init__()
        self.conv1 = GCNConv(nfeat, nhid, cached=False, normalize=True)
        self.conv2 = GCNConv(nhid, nclass, cached=False, normalize=True)
...
def create_gcn(nfeat, nhid, nclass, dropout, nlayer):
    if nlayer == 1:
        model = GensGCN1(nfeat, nhid, nclass, dropout, nlayer)
    elif nlayer == 2:
        model = GensGCN2(nfeat, nhid, nclass, dropout, nlayer)
    else:
        model = GensGCNX(nfeat, nhid, nclass, dropout, nlayer)
